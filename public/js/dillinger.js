...
//    Notifier.showMessage(Notifier.messages.profileCleared, 1400)
  ...
  function showAboutInfo(){
    ...
    var aboutContent =  "<p>Cleopatra is an online cloud-enabled, HTML5, buzzword-filled Markdown editor.</p>"
                      + "<p>Cleopatra was designed and developed by <a href='http://github.com/dreamsofpy'>dreamsofpy</a> because we needed a decent Markdown resume builder.</p>"
                      + "<p>Cleopatra is a 100% open source project so <a href='https://github.com/dreamsofpy/cleopatra'>fork the code</a> and contribute!</p>"

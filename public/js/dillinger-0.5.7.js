...
//    Notifier.showMessage(Notifier.messages.profileCleared, 1400)
  ...
  function showAboutInfo(){
    ...
    var aboutContent =  "<p>Cleopatra is an online cloud-enabled, HTML5, buzzword-filled Markdown editor.</p>"
                      + "<p>Cleopatra was designed and developed by <a href='https://github.com/DreamsofPy/cleopatra'>dreams of py</a>.</p>"
                      + "<p>Dillinger is a 100% open source project so <a href='https://github.com/DreamsofPy/cleopatra'>fork the code</a> and contribute!</p>"
